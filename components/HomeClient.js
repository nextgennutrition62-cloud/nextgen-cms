            ...
            <div className="checkout-grid">
              ...
              <div className="checkout-form-side">
                ...
                <form onSubmit={submitOrder}>
                  ...
                  <div className="form-field"><label>Улица</label><input type="text" required value={form.street || ''} placeholder="пр. Вардарска" onChange={e => setForm({ ...form, street: e.target.value, address: `${e.target.value} ${form.streetNum || ''}, ${form.city || ''}` })} /></div>
                  <div className="form-row-2">
                    <div className="form-field"><label>Број</label><input type="text" required value={form.streetNum || ''} placeholder="пр. 192 А" pattern=".*[0-9].*" title="Внеси број на улица" onChange={e => setForm({ ...form, streetNum: e.target.value, address: `${form.street || ''} ${e.target.value}, ${form.city || ''}` })} /></div>
